...
export const pastExamsDB: PrivateExercise[] = [
  ...
  },
  {
    ...
    numero: 1,
    enunciado: "Bob Esponja necesita medir el volumen de la piña donde vive. Él sabe perfectamente que, aunque no se nota a simple vista, su casa tiene una forma parabólica prácticamente perfecta. Ha logrado medir la base de su piña, obteniendo el radio, y además ha medido la altura total de la estructura. Desarrolle un algoritmo que reciba estos datos por parte del usuario y calcule el volumen exacto de la piña aplicando la fórmula del volumen de un paraboloide:\nVolumen = 0.5 * PI * radio^2 * altura (use PI = 3.1416)",
    puntosMaximos: 1.5,
    solucionOficial: {
      pseudocodigo: `ALGORITMO VolumenPiña\nDECLARACIÓN\nVARIABLES\n  radio, altura, volumen: real\nINICIO\n  ESCRIBIR "Ingrese el radio de la base de la piña:"\n  LEER radio\n  ESCRIBIR "Ingrese la altura de la piña:"\n  LEER altura\n  volumen <- 0.5 * 3.1416 * radio * radio * altura\n  ESCRIBIR "El volumen exacto de la piña es: ", volumen\nFIN`,
      c: `#include <stdio.h>\n\nint main() {\n    float radio, altura, volumen;\n    printf("Ingrese el radio de la base de la piña:\\n");\n    scanf("%f", &radio);\n    printf("Ingrese la altura de la piña:\\n");\n    scanf("%f", &altura);\n    volumen = 0.5 * 3.1416 * radio * radio * altura;\n    printf("El volumen exacto de la piña es: %.4f\\n", volumen);\n    return 0;\n}`,
      typescript: `function calcularVolumenPina(radio: number, altura: number): number {\n  const volumen = 0.5 * 3.1416 * radio * radio * altura;\n  return volumen;\n}`
    }
  },
  {
    id: "pe_bob_2026_02",
    categoria: "anidados",
    numero: 2,
    enunciado: "El Ministerio de Tránsito de Fondo de Bikini ha implementado pruebas dinámicas. La evaluación de Bob Esponja ahora depende de la zona por la que transita y de las reglas específicas de cada área. Diseñe un algoritmo que evalúe el desempeño de manejo recibiendo los siguientes datos de entrada: cantidad de botes chocados (entero), zona de conducción (texto, ej: 'Zona Escolar' o 'Autopista'), velocidad actual (real) y el estado de las luces del bote (texto: 'Encendidas' o 'Apagadas').\n\nLa lógica del sistema debe regirse por las siguientes normativas:\n- Cualquier colisión (botes chocados mayores a cero) resulta en la reprobación automática e inmediata del examen.\n- Si el conductor transita por una 'Zona Escolar', la velocidad máxima permitida es de 20.0. Superar este límite es motivo de reprobación; de lo contrario, se supera la zona con éxito.\n- Si el conductor transita por una 'Autopista', las reglas son más estrictas: conducir a menos de 60.0 o llevar las luces apagadas se considera un peligro vial y es motivo de reprobación. El límite máximo de velocidad es 80.0 (excederlo también reprueba). Solo se aprueba si se conduce dentro del rango permitido con las luces encendidas.\n- El algoritmo debe ser capaz de arrojar un error de sistema si el dispositivo de navegación indica una zona no reconocida.",
    puntosMaximos: 2.5,
    solucionOficial: {
      pseudocodigo: `ALGORITMO ExamenConducirPuff\nDECLARACIÓN\nVARIABLES\n  botesChocados: entero\n  zona, luces: texto\n  velocidad: real\nINICIO\n  ESCRIBIR "Ingrese la cantidad de botes chocados:"\n  LEER botesChocados\n  ESCRIBIR "Ingrese la zona de conduccion:"\n  LEER zona\n  ESCRIBIR "Ingrese la velocidad actual del bote:"\n  LEER velocidad\n  ESCRIBIR "Ingrese el estado de las luces (Encendidas/Apagadas):"\n  LEER luces\n\n  SI (botesChocados > 0) ENTONCES\n    ESCRIBIR "Reprobado. Colision detectada."\n  SINO\n    SI (zona = "Zona Escolar") ENTONCES\n      SI (velocidad > 20.0) ENTONCES\n        ESCRIBIR "Reprobado. Exceso de velocidad en zona escolar."\n      SINO\n        ESCRIBIR "Aprobado. Zona escolar superada con exito."\n      FIN SI\n    SINO\n      SI (zona = "Autopista") ENTONCES\n        SI (velocidad < 60.0 O velocidad > 80.0 O luces = "Apagadas") ENTONCES\n          ESCRIBIR "Reprobado. Peligro vial en autopista."\n        SINO\n          ESCRIBIR "Aprobado. Autopista superada con exito."\n        FIN SI\n      SINO\n        ESCRIBIR "ERROR: Zona no reconocida."\n      FIN SI\n    FIN SI\n  FIN SI\nFIN`,
      c: `#include <stdio.h>\n#include <string.h>\n\nint main() {\n    int botesChocados;\n    char zona[50], luces[20];\n    float velocidad;\n    printf("Ingrese la cantidad de botes chocados:\\n");\n    scanf("%d", &botesChocados);\n    printf("Ingrese la zona de conduccion:\\n");\n    getchar();\n    fgets(zona, sizeof(zona), stdin);\n    zona[strcspn(zona, "\\n")] = 0;\n    printf("Ingrese la velocidad actual del bote:\\n");\n    scanf("%f", &velocidad);\n    printf("Ingrese el estado de las luces (Encendidas/Apagadas):\\n");\n    scanf("%s", luces);\n\n    if (botesChocados > 0) {\n        printf("Reprobado. Colision detectada.\\n");\n    } else {\n        if (strcmp(zona, "Zona Escolar") == 0) {\n            if (velocidad > 20.0) {\n                printf("Reprobado. Exceso de velocidad en zona escolar.\\n");\n            } else {\n                printf("Aprobado. Zona escolar superada con exito.\\n");\n            }\n        } else if (strcmp(zona, "Autopista") == 0) {\n            if (velocidad < 60.0 || velocidad > 80.0 || strcmp(luces, "Apagadas") == 0) {\n                printf("Reprobado. Peligro vial en autopista.\\n");\n            } else {\n                printf("Aprobado. Autopista superada con exito.\\n");\n            }\n        } else {\n            printf("ERROR: Zona no reconocida.\\n");\n        }\n    }\n    return 0;\n}`,
      typescript: `function evaluarExamenConducir(botesChocados: number, zona: string, velocidad: number, luces: string): string {\n  if (botesChocados > 0) {\n    return "Reprobado. Colision detectada.";\n  }\n  if (zona === "Zona Escolar") {\n    if (velocidad > 20.0) {\n      return "Reprobado. Exceso de velocidad en zona escolar.";\n    }\n    return "Aprobado. Zona escolar superada con exito.";\n  } else if (zona === "Autopista") {\n    if (velocidad < 60.0 || velocidad > 80.0 || luces === "Apagadas") {\n      return "Reprobado. Peligro vial en autopista.";\n    }\n    return "Aprobado. Autopista superada con exito.";\n  } else {\n    return "ERROR: Zona no reconocida.";\n  }\n}`
    }
  },
  {
    id: "pe_bob_2026_03",
    categoria: "ciclos-sencillos",
    numero: 3,
    enunciado: "La población de medusas rosadas en los Campos de Medusas crece siguiendo un patrón matemático exacto basado en la Sucesión de Fibonacci Xn = Xn-1 + Xn-2. Se sabe que el día 1 hay 0 medusas nuevas, el día 2 hay 1, el día 3 hay 1, el día 4 hay 2, el día 5 hay 3, y así sucesivamente.\n\nReto del Estudiante: Desarrolle un algoritmo que, dado un día N ingresado por el usuario (entero positivo), determine exactamente cuántas medusas nuevas habrá ese día.",
    puntosMaximos: 2.5,
    solucionOficial: {
      pseudocodigo: `ALGORITMO MultiplicacionMedusas\nDECLARACIÓN\nVARIABLES\n  n, i: entero\n  x1, x2, xn: entero\nINICIO\n  ESCRIBIR "Ingrese el dia N:"\n  LEER n\n  SI (n = 1) ENTONCES\n    xn <- 0\n  SINO\n    SI (n = 2) ENTONCES\n      xn <- 1\n    SINO\n      x1 <- 0\n      x2 <- 1\n      PARA i <- 3 HASTA n CON PASO 1 HACER\n        xn <- x1 + x2\n        x1 <- x2\n        x2 <- xn\n      FIN PARA\n    FIN SI\n  FIN SI\n  ESCRIBIR "El dia ", n, " habra ", xn, " medusas nuevas."\nFIN`,
      c: `#include <stdio.h>\n\nint main() {\n    int n, i;\n    int x1, x2, xn = 0;\n    printf("Ingrese el dia N:\\n");\n    scanf("%d", &n);\n    if (n == 1) {\n        xn = 0;\n    } else if (n == 2) {\n        xn = 1;\n    } else {\n        x1 = 0;\n        x2 = 1;\n        for (i = 3; i <= n; i++) {\n            xn = x1 + x2;\n            x1 = x2;\n            x2 = xn;\n        }\n    }\n    printf("El dia %d habra %d medusas nuevas.\\n", n, xn);\n    return 0;\n}`,
      typescript: `function calcularMedusas(n: number): number {\n  if (n === 1) return 0;\n  if (n === 2) return 1;\n  let x1 = 0;\n  let x2 = 1;\n  let xn = 0;\n  for (let i = 3; i <= n; i++) {\n    xn = x1 + x2;\n    x1 = x2;\n    x2 = xn;\n  }\n  return xn;\n}`
    }
  },
  {
    id: "pe_bob_2026_04",
    categoria: "ciclos-largos",
    numero: 4,
    enunciado: "El Crustáceo Cascarudo requiere modernizar su sistema de toma de pedidos para ayudar a Calamardo durante su turno. El menú actual del restaurante cuenta con los siguientes productos y precios:\n- Cangreburger: 1.50 dólares\n- Papas Fritas: 1.50 dólares\n- Refrescos: 1.00 dólar\n\nDiseñe un programa que permita a Calamardo tomar las órdenes de los clientes de forma continua. El sistema debe permitir registrar múltiples artículos por cliente, indicar en qué momento se debe cerrar la cuenta individual y mostrar el monto total a pagar por ese cliente. El programa debe mantenerse operativo procesando clientes hasta que Calamardo decida finalizar su jornada laboral (indicando 'Si' o 'No').\n\nAl realizar el cierre de caja, el sistema debe emitir un reporte gerencial para Don Cangrejo que indique:\n1. El total de dinero recaudado durante todo el día.\n2. El promedio de gasto por compra/cliente.\n3. El monto gastado por el cliente que realizó la compra más grande (el que más gastó).",
    puntosMaximos: 3.5,
    solucionOficial: {
      pseudocodigo: `ALGORITMO CajaCrustaceoCascarudo\nDECLARACIÓN\nVARIABLES\n  opcion, cantClientes: entero\n  totalDia, promedioGasto, compraMasGrande, cuentaCliente: real\n  finalizarJornada, cerrarCuenta: texto\nINICIO\n  totalDia <- 0.0\n  cantClientes <- 0\n  compraMasGrande <- 0.0\n  finalizarJornada <- "No"\n  MIENTRAS (finalizarJornada = "No") HACER\n    cuentaCliente <- 0.0\n    cerrarCuenta <- "No"\n    ESCRIBIR "--- NUEVO CLIENTE ---"\n    MIENTRAS (cerrarCuenta = "No") HACER\n      ESCRIBIR "Ingrese el producto (1: Cangreburger, 2: Papas Fritas, 3: Refrescos, 0: Cerrar Cuenta):"\n      LEER opcion\n      SI (opcion = 1) ENTONCES\n        cuentaCliente <- cuentaCliente + 1.50\n      SINO\n        SI (opcion = 2) ENTONCES\n          cuentaCliente <- cuentaCliente + 1.50\n        SINO\n          SI (opcion = 3) ENTONCES\n            cuentaCliente <- cuentaCliente + 1.00\n          SINO\n            SI (opcion = 0) ENTONCES\n              cerrarCuenta <- "Si"\n            SINO\n              ESCRIBIR "Opcion no valida."\n            FIN SI\n          FIN SI\n        FIN SI\n      FIN SI\n    FIN MIENTRAS\n    ESCRIBIR "Monto total a pagar por el cliente: $", cuentaCliente\n    totalDia <- totalDia + cuentaCliente\n    cantClientes <- cantClientes + 1\n    SI (cuentaCliente > compraMasGrande) ENTONCES\n      compraMasGrande <- cuentaCliente\n    FIN SI\n    ESCRIBIR "¿Desea finalizar la jornada laboral de hoy? (Si/No):"\n    LEER finalizarJornada\n  FIN MIENTRAS\n  SI (cantClientes > 0) ENTONCES\n    promedioGasto <- totalDia / cantClientes\n  SINO\n    promedioGasto <- 0.0\n  FIN SI\n  ESCRIBIR "=== REPORTE GERENCIAL PARA DON CANGREJO ==="\n  ESCRIBIR "Total recaudado: $", totalDia\n  ESCRIBIR "Promedio de gasto por cliente: $", promedioGasto\n  ESCRIBIR "Compra mas grande: $", compraMasGrande\nFIN`,
      c: `#include <stdio.h>\n#include <string.h>\n\nint main() {\n    int opcion;\n    int cantClientes = 0;\n    double totalDia = 0.0, promedioGasto = 0.0, compraMasGrande = 0.0, cuentaCliente = 0.0;\n    char finalizarJornada[10] = "No";\n    char cerrarCuenta[10];\n    while (strcmp(finalizarJornada, "No") == 0) {\n        cuentaCliente = 0.0;\n        strcpy(cerrarCuenta, "No");\n        printf("--- NUEVO CLIENTE ---\\n");\n        while (strcmp(cerrarCuenta, "No") == 0) {\n            printf("Ingrese el producto (1: Cangreburger, 2: Papas Fritas, 3: Refrescos, 0: Cerrar Cuenta):\\n");\n            scanf("%d", &opcion);\n            if (opcion == 1) {\n                cuentaCliente += 1.50;\n            } else if (opcion == 2) {\n                cuentaCliente += 1.50;\n            } else if (opcion == 3) {\n                cuentaCliente += 1.00;\n            } else if (opcion == 0) {\n                strcpy(cerrarCuenta, "Si");\n            } else {\n                printf("Opcion no valida.\\n");\n            }\n        }\n        printf("Monto total a pagar por el cliente: $%.2f\\n", cuentaCliente);\n        totalDia += cuentaCliente;\n        cantClientes++;\n        if (cuentaCliente > compraMasGrande) {\n            compraMasGrande = cuentaCliente;\n        }\n        printf("¿Desea finalizar la jornada laboral de hoy? (Si/No):\\n");\n        scanf("%s", finalizarJornada);\n    }\n    if (cantClientes > 0) {\n        promedioGasto = totalDia / cantClientes;\n    }\n    printf("=== REPORTE GERENCIAL PARA DON CANGREJO ===\\n");\n    printf("Total recaudado: $%.2f\\n", totalDia);\n    printf("Promedio de gasto por cliente: $%.2f\\n", promedioGasto);\n    printf("Compra mas grande: $%.2f\\n", compraMasGrande);\n    return 0;\n}`,
      typescript: `interface ReporteCaja {\n  totalRecaudado: number;\n  promedioGasto: number;\n  compraMasGrande: number;\n}\n\nfunction simularCajaCrustaceo(clientesPedidos: number[][]): ReporteCaja {\n  let totalDia = 0;\n  let cantClientes = 0;\n  let compraMasGrande = 0;\n  for (const pedido of clientesPedidos) {\n    let cuentaCliente = 0;\n    for (const opcion of pedido) {\n      if (opcion === 1) cuentaCliente += 1.50;\n      else if (opcion === 2) cuentaCliente += 1.50;\n      else if (opcion === 3) cuentaCliente += 1.00;\n    }\n    totalDia += cuentaCliente;\n    cantClientes++;\n    if (cuentaCliente > compraMasGrande) {\n      compraMasGrande = cuentaCliente;\n    }\n  }\n  const promedioGasto = cantClientes > 0 ? totalDia / cantClientes : 0;\n  return {\n    totalRecaudado: totalDia,\n    promedioGasto,\n    compraMasGrande\n  };\n}`
    }
  },
  {
    id: "pe_bob_2026_05",
    categoria: "secuenciales",
    numero: 5,
    enunciado: "Tanto Patricio Estrella como Calamardo Tentáculos necesitan calcular el volumen que ocupan sus respectivas viviendas para un censo municipal. La Roca de Patricio: Su vivienda tiene la forma geométrica de una semiesfera perfecta. Patricio ha logrado medir el radio de la base. El algoritmo debe calcular el volumen de su casa aplicando la fórmula del volumen de una semiesfera:\nVolumen = (2/3) * PI * radio^3 (use PI = 3.1416)",
    puntosMaximos: 1.5,
    solucionOficial: {
      pseudocodigo: `ALGORITMO VolumenRocaPatricio\nDECLARACIÓN\nVARIABLES\n  radio, volumen: real\nINICIO\n  ESCRIBIR "Ingrese el radio de la roca de Patricio:"\n  LEER radio\n  volumen <- (2.0 / 3.0) * 3.1416 * radio * radio * radio\n  ESCRIBIR "El volumen de la roca es: ", volumen\nFIN`,
      c: `#include <stdio.h>\n\nint main() {\n    float radio, volumen;\n    printf("Ingrese el radio de la roca de Patricio:\\n");\n    scanf("%f", &radio);\n    volumen = (2.0 / 3.0) * 3.1416 * radio * radio * radio;\n    printf("El volumen de la roca es: %.4f\\n", volumen);\n    return 0;\n}`,
      typescript: `function calcularVolumenRoca(radio: number): number {\n  const volumen = (2.0 / 3.0) * 3.1416 * Math.pow(radio, 3);\n  return volumen;\n}`
    }
  },
  {
    id: "pe_bob_2026_06",
    categoria: "ciclos-sencillos",
    numero: 6,
    enunciado: "En un momento de aburrimiento en su oficina, Don Cangrejo decide apilar todos sus ahorros en efectivo formando una pirámide triangular perfecta con monedas de un centavo. La construcción sigue un patrón de progresión aritmética: en la punta (nivel 1) coloca 1 centavo, en el nivel inmediatamente inferior (nivel 2) coloca 2 centavos, en el nivel 3 coloca 3 centavos, y así sucesivamente.\n\nReto del Estudiante: Desarrolle un programa donde el usuario ingrese la cantidad total de centavos C que posee Don Cangrejo. Mediante el uso estricto de una estructura cíclica indeterminada (bucle MIENTRAS), el sistema debe simular la construcción de la pirámide, restando los centavos nivel por nivel. Al finalizar, el programa debe indicar exactamente cuántos niveles completos logró armar y cuántos centavos le sobraron al no alcanzar a completar una base nueva.",
    puntosMaximos: 2.5,
    solucionOficial: {
      pseudocodigo: `ALGORITMO PiramideCentavos\nDECLARACIÓN\nVARIABLES\n  centavos, nivel, nivelesCompletos, sobrante: entero\nINICIO\n  ESCRIBIR "Ingrese la cantidad total de centavos:"\n  LEER centavos\n  sobrante <- centavos\n  nivel <- 1\n  nivelesCompletos <- 0\n  MIENTRAS (sobrante >= nivel) HACER\n    sobrante <- sobrante - nivel\n    nivelesCompletos <- nivelesCompletos + 1\n    nivel <- nivel + 1\n  FIN MIENTRAS\n  ESCRIBIR "Niveles completos logrados: ", nivelesCompletos\n  ESCRIBIR "Centavos sobrantes: ", sobrante\nFIN`,
      c: `#include <stdio.h>\n\nint main() {\n    int centavos, nivel = 1, nivelesCompletos = 0, sobrante;\n    printf("Ingrese la cantidad total de centavos:\\n");\n    scanf("%d", &centavos);\n    sobrante = centavos;\n    while (sobrante >= nivel) {\n        sobrante -= nivel;\n        nivelesCompletos++;\n        nivel++;\n    }\n    printf("Niveles completos logrados: %d\\n", nivelesCompletos);\n    printf("Centavos sobrantes: %d\\n", sobrante);\n    return 0;\n}`,
      typescript: `function simularPiramideCentavos(centavos: number): { nivelesCompletos: number, sobrante: number } {\n  let sobrante = centavos;\n  let nivel = 1;\n  let nivelesCompletos = 0;\n  while (sobrante >= nivel) {\n    sobrante -= nivel;\n    nivelesCompletos++;\n    nivel++;\n  }\n  return { nivelesCompletos, sobrante };\n}`
    }
  }
];
